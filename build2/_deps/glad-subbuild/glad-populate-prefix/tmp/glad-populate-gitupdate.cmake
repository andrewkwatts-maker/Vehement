...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v2.0.6"
  WORKING_DIRECTORY "H:/Github/Old3DEngine/build2/_deps/glad-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'H:/Github/Old3DEngine/build2/_deps/glad-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'H:/Github/Old3DEngine/build2/_deps/glad-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
